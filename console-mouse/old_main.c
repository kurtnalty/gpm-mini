...
//  int do_client(Gpm_Cinfo *cinfo, Gpm_Event *event)  /* returns 0 if the event has not been processed, and 1 if it has KN */
//  int do_selection(Gpm_Event *event)  /* returns 0, always, but handles selection process */
