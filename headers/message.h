...
#define GPM_MESS_USAGE              "Usage: %s [options]\n" \
         ...
         "    Examples:\n\n" \
         "    gpm -m /dev/input/mice -t ps2    to start with all mice\n" \
         "    gpm -m /dev/input/mouse1 -t ps2  to only use mouse1\n\n" 
...
/* mem */
#define GPM_MESS_NO_MEM             "I could not get any memory! I died! :("
